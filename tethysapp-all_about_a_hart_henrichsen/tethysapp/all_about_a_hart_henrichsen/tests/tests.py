...
# from ..app import AllAboutAHartHenrichsen
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.all_about_a_hart_henrichsen"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.all_about_a_hart_henrichsen.tests.tests"

        To run tests in the AllAboutAHartHenrichsenTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.all_about_a_hart_henrichsen.tests.tests.AllAboutAHartHenrichsenTestCase"

        To run only the test_if_tethys_platform_is_great function in the AllAboutAHartHenrichsenTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.all_about_a_hart_henrichsen.tests.tests.AllAboutAHartHenrichsenTestCase.test_if_tethys_platform_is_great"
...
class AllAboutAHartHenrichsenTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(AllAboutAHartHenrichsen)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(AllAboutAHartHenrichsen)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/all-about-a-hart-henrichsen/')  # The final '/' is essential for all pages/controllers
